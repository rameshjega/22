 ...
 <div class="row">
  ...
  <script src="jquery-2.1.1.min.js"></script>
        <div class="row">
            <div class="col-sm-12">
                <section class="panel">
                    <header class="panel-heading"> View Tax
                        <span class="tools pull-right">
                             <script src="jquery-2.1.1.min.js"></script>
							 <?php    $sql_queryd=" SELECT * FROM    billing_tax 
				  WHERE tax_company_ref_id='$company_sl_no' ";
...
data-target="#create_user"
						   ...
						   <i class="fa fa-plus"></i>&nbsp; Create Tax</a>
						   <?php }?>
 ...
 <div class="modal-body">
                ...
                <tbody>  
					...
					<td>  <input type="text" name="tax_name[]" class="form-control f-name01" required=""></td>  
         ...
         <div class="modal-footer">
            ...
            <button type="submit" name="save_components" class="btn btn-primary"><i class="fa fa-check-square-o"></i> Submit</button>
				...
				$i=1;
				  $sql_query=" SELECT * FROM    billing_tax 
				  WHERE tax_company_ref_id='$company_sl_no' ";
				...
				{ ?>;
                            <tr class="odd gradeX">
                               <td><?php echo $i++;?></td>
										 ...
										 <td><?php 
$tax_created_by=$row['tax_created_by'];
$exe="SELECT * FROM   tbl_add_user where  admin_login_no='$tax_created_by' ";
...
data-target="#update_<?php echo $row['tax_sl_no'];?>"
class="label label-success">&nbsp;&nbsp;Edit&nbsp;&nbsp;</a>
								<a href="#" data-toggle="modal" 
data-target="#delete_<?php echo $row['tax_sl_no'];?>" class="label label-danger  btn-danger">Delete</a>
								</td>
                            </tr>
					<div class="modal fade" id="update_<?php echo $row['tax_sl_no'];?>">
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
  <?php 
   $tax_sl_no=$row['tax_sl_no'];
  $exe="SELECT * FROM   billing_tax where  tax_sl_no='$tax_sl_no' ";
$exe_result=mysql_query($exe);
...
?>
 ...
 <div class="modal-body">
                                 ...
                                 <div class="row-fluid">
                                     <div class="col-md-612">
										...
										<div class="controls controls-row">
										 ...
										 value="<?php echo $row_results['tax_name'];?>"  required>
										</div>
										</div>
          	...
          	<input type="hidden" name="tax_sl_no" value="<?php echo $row_results['tax_sl_no'];?>"> 
         ...
         <div class="modal-footer">
            ...
            <button type="submit" name="update_components" class="btn btn-primary"><i class="fa fa-check-square-o"></i> Submit</button>
							...
							<div class="modal fade" id="delete_<?php echo $row['tax_sl_no'];?>">
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
	  <form method="post">
         <div class="modal-header">
			...
			<div class="modal-body">
			<input type="hidden" name="tax_sl_no" value="<?php echo $row['tax_sl_no'];?>">
 ...
 if (isset($_POST['save_components']))
		 ...
		 $tax_name=$_POST['tax_name'];
			 $tax_company_ref_id= $_SESSION["company_sl_no"];
			 $tax_created_by=$_SESSION["admin_login_no"];
			 $tax_created=date('Y-m-d');
						 
		for ($y = 0; $y < count($tax_name); $y++) 
	{
			
		$sql_query =  "insert into billing_tax(tax_name,
		tax_company_ref_id,tax_created_by,tax_created)
		values('$tax_name[$y]','$tax_company_ref_id',
		'$tax_created_by',
		'$tax_created')";
		$query = mysql_query($sql_query); 	
					...
					window.location.href = "tax_setting.php";</script>';
				}
				...
				{	    
					$tax_sl_no=$_POST['tax_sl_no'];
		 $tax_name=$_POST['tax_name'];
			 
						$sql_query =  "UPDATE billing_tax
   
						SET tax_name ='$tax_name'       WHERE  tax_sl_no='$tax_sl_no'";
						$query = mysql_query($sql_query); 
				...
				{	    
					$tax_sl_no=$_POST['tax_sl_no'];
						...
						$sql_query =  "DELETE FROM  billing_tax
    WHERE  tax_sl_no='$tax_sl_no'";
						$query = mysql_query($sql_query); 

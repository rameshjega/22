 ...
 <div class="row">
                  <div class="col-lg-12">
                     ...
                     <ul class="breadcrumb">
                          ...
                          <li class="active">View Stock Report </li>
                      </ul>
                      <!--breadcrumbs end -->
                  </div>
              </div>
  <script src="jquery-2.1.1.min.js"></script>
        <div class="row">
            <div class="col-sm-12">
                <section class="panel">
                    <header class="panel-heading"> View Stock Report<?php if (isset($_POST['save_components']))
				{	 
...
<input type="date"  name="to_date"   class="form-control"  value="" required >
         ...
         <div class="modal-footer">
			...
			$to_date=$_POST['to_date'];
				  ...
				  AND (product_created BETWEEN  '$from_date' AND '$to_date')
				  ";
				}else{
				  $sql_query=" SELECT * FROM    billing_product_master ,billing_category,billing_sub_category
				  WHERE product_company_ref_id='$company_sl_no' AND category_ref_id=category_sl_no

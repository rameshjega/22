 ...
 <div class="row">
  ...
  <script src="jquery-2.1.1.min.js"></script>
        <div class="row">
            <div class="col-sm-12">
                <section class="panel">
                    <header class="panel-heading"> View Sales Report<?php if (isset($_POST['save_components']))
				{	 
...
<input type="date"  name="to_date"   class="form-control"  value="" required >
         ...
         <div class="modal-footer">
			...
			$from_date=$_POST['from_date'];
			$to_date=$_POST['to_date'];
				    $sql_query=" SELECT * FROM    billing_sale_master ,billing_customer
				  WHERE sale_company_ref_id='$company_sl_no' AND sale_customer_ref_id=customer_sl_no
				  AND (sale_created BETWEEN  '$from_date' AND '$to_date')
				  ";
				}else{
				  $sql_query=" SELECT * FROM    billing_sale_master ,billing_customer
				  WHERE sale_company_ref_id='$company_sl_no' AND sale_customer_ref_id=customer_sl_no";
				...
				{ ?>
                            <tr class="odd gradeX">
                               <td><?php echo $i++;?></td>
										 ...
										 <td><?php echo $row['sale_payable_amount'];?></td> 
										 <td><?php echo $sale_status= $row['sale_status'];?></td> 
										 <td><?php 
$sale_created_by=$row['sale_created_by'];
$exe="SELECT * FROM   tbl_add_user where  admin_login_no='$sale_created_by' ";
